...
class Critic(nn.Module):
    def __init__(self, device, obs_size=7, action_dim=9, seq_len=256, h_dim=256, is_traj=False, num_pref=6):
        ...
        self.h_dim = h_dim
        self.embed_link = nn.Embedding(5524, h_dim)
        self.embed_o = nn.Embedding(5524, h_dim)
        self.embed_d = nn.Embedding(5524, h_dim)
        ...
        self.preference_token_embedding = nn.Embedding(512, h_dim)
